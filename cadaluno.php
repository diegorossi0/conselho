...
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <input type="file" name="txtArq"><br><br>
        ...
        <?php
            ...
            if(isset($_POST["btGravar"])) {           
                ...
                $ext = strtolower(substr($_FILES['txtArq']['name'],-4));
                $new_name = $Nome . date("Y.m.d-H.i.s") . $ext;
                $dir = 'img/';
                move_uploaded_file($_FILES['txtArq']['tmp_name'], $dir.$new_name);

                //inserir o problema
                $sql = "INSERT INTO `aluno`( `Nome`, `Imagem`) VALUES ('$Nome', '$dir.$new_name')";
